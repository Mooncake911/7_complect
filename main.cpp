...
int main() {
    ...
    while (getline(work_file, line))
    {
        ...
        string row = person.login + person.name + person.shell + person.home_directory;
        myMap.insert(pair<string, Account>(row, person));
